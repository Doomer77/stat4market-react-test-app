      ...
      <header className="header">
        <div className="row">
          <div className="col-auto">
            <div className="logo-box">
              ...
              <span className="logo-text">
                stat<span className="logo-text--mod">4</span>market
              </span>
            </div>
          </div>
          <div className="col">
            <div className="header-box header-box--id">
              ...
              <span className="box-text box-text--id">
                <span className="box-text--hide">Ozon</span> (№28451)
              </span>
            </div>
          </div>
          <div className="col-auto">
            <div className="header-box header-box--budget">
              <img
                src={dollarIcon}
                alt={dollarIcon}
                className="box-budget__icon"
              />
              <span className="box-text box-text--balance">
                9 932.00&nbsp;&#8381;
              </span>
          ...
          <div className="col-auto">
            <div
              className={
                menuAvtive ? "header-box__user show" : "header-box__user"
              }
            >
              <a
                href="/"
                className="header-box__link header-box__link--notification"
              >
                <img
                  src={bellIcon}
                  alt={bellIcon}
              ...
              <a href="/" className="header-box__link-account">
                ...
                <img
                  src={arrowDownIcon}
                  alt={arrowDownIcon}
                  className="header-box__arrow-down"
                />
              </a>
            </div>
          </div>
          <div className="col-auto">
            <div
              className="box-menu"
              onClick={() => setMenuActive(!menuAvtive)}
            >
